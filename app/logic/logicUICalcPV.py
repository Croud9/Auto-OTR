import os, math, xlwt
import pandas as pd
from views import designCalcPV, styles_and_animation
from helpers import search_data, validate
...
class CalcPV(QtWidgets.QMainWindow, designCalcPV.Ui_MainWindow):
    def __init__(self, instance_of_main_window):
        ...
        self.tableWidget.resize(669, 510)
    ...
    def input_data(self):
        self.comboBox_stcnoct.addItem("Выберите")
        self.comboBox_stcnoct.addItem("STC")
        self.comboBox_stcnoct.addItem("NOCT")
        self.comboBox_city.addItem("Выберите город")
    ...
    def import_sp(self):
        nameCity = []
        cols = [0, 5, 17, 22]
        readFrame = pd.read_excel('Data/System/SP/SP_cold_and_hot.xlsx', usecols=cols, header=5)
    ...
    def set_style_default(self):      
        self.lineEdit_calcmintemp.setStyleSheet(styles_and_animation.default_style_input)
        self.lineEdit_calcmaxtemp.setStyleSheet(styles_and_animation.default_style_input)
        self.lineEdit_min.setStyleSheet(styles_and_animation.default_style_input)
        self.lineEdit_max.setStyleSheet(styles_and_animation.default_style_input)
        self.lineEdit_mintemp.setStyleSheet(styles_and_animation.default_style_input)
        self.lineEdit_countfem.setStyleSheet(styles_and_animation.default_style_input)
        self.lineEdit_countparallel.setStyleSheet(styles_and_animation.default_style_input)
        self.lineEdit_noct.setStyleSheet(styles_and_animation.default_style_input)
        self.lineEdit_irradiance.setStyleSheet(styles_and_animation.default_style_input)
        self.lineEdit_pnom.setStyleSheet(styles_and_animation.default_style_input) #PAN or imput
        self.lineEdit_isc.setStyleSheet(styles_and_animation.default_style_input)
        self.lineEdit_voc.setStyleSheet(styles_and_animation.default_style_input)
        self.lineEdit_imp.setStyleSheet(styles_and_animation.default_style_input)
        self.lineEdit_vmp.setStyleSheet(styles_and_animation.default_style_input)
        self.lineEdit_muisc.setStyleSheet(styles_and_animation.default_style_input)
        self.lineEdit_muvocspec.setStyleSheet(styles_and_animation.default_style_input)
        self.lineEdit_vmaxiec.setStyleSheet(styles_and_animation.default_style_input)
        self.lineEdit_rshunt.setStyleSheet(styles_and_animation.default_style_input)
        self.lineEdit_ncels.setStyleSheet(styles_and_animation.default_style_input)
        self.lineEdit_umax_pogran.setStyleSheet(styles_and_animation.default_style_input)
        self.lineEdit_imax_pogran.setStyleSheet(styles_and_animation.default_style_input)
